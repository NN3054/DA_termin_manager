...
class DatabaseHelper {
  Future<Database> database() async {
    return openDatabase(
      ...
      onCreate: (db, version) async {
        ...
        await db.execute(
          "CREATE Table customers(id INTEGER PRIMARY KEY, vorname TEXT, nachname TEXT, telefonnummer TEXT, email TEXT)",
        );
  ...
  Future<void> updateMeeting(
      int id, String vorname, String nachname, String behandlungsart) async {
    Database _db = await database();
    await _db.rawUpdate(
        "UPDATE meetings SET vorname = '$vorname', nachname = '$nachname', behandlungsart = '$behandlungsart' WHERE id = '$id'");
  }
